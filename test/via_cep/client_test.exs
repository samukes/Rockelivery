defmodule Rockelivery.ViaCep.ClientTest do
  ...
  describe "get_cep_info/1" do
    ...
    test "when invalid cep, gets error", %{bypass: bypass} do
      cep = "123"
    ...
    test "when cep not found, gets error", %{bypass: bypass} do
      cep = "00000000"
    ...
    test "when generic problem, gets error", %{bypass: bypass} do
      cep = "00000000"
    ...
    defp endpoint_port(port), do: "http://localhost:#{port}/"
  end
end
